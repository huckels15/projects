...
DATA_IMAGE = "huckels15/ap-resnet-data"
...
def data_download():
    ...
    DISPLAY_NAME = "resnet-data-download-" + job_id
    job = aip.PipelineJob(
...
def adv_model_training():
    ...
    job_id = generate_uuid()
    DISPLAY_NAME = "black-knights-adv-resnet-training-" + job_id
    job = aip.PipelineJob(
        display_name=DISPLAY_NAME,
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--pipeline",
        action="store_true",
        help="Black Knights Resnet Pipeline",
    )
