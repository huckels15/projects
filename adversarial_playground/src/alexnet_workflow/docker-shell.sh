...
export IMAGE_NAME="ac215-black-knights-workflow-alex"
export BASE_DIR=$(pwd)
export SECRETS_DIR=$(pwd)/../../../secrets/
export GCP_PROJECT="secret-cipher-399620"
export GCS_BUCKET_NAME_NORM="alexnet-models-ac215"
export GCS_BUCKET_NAME_ADV="pgd-at-alexnet-models-ac215"
export GCS_SERVICE_ACCOUNT="ml-workflow@secret-cipher-399620.iam.gserviceaccount.com"
export GCP_REGION="us-east1"
export GCS_PACKAGE_URI_NORM="gs://alexnet-trainer"
export GCS_PACKAGE_URI_ADV="gs://pgd-at-alexnet-trainer"
