...
export DISPLAY_NAME="pgd_at_alexnet_training_job_$UUID"
export MACHINE_TYPE="n1-standard-8"
export REPLICA_COUNT=1
export EXECUTOR_IMAGE_URI="us-docker.pkg.dev/vertex-ai/training/tf-gpu.2-14.py310:latest"
export PYTHON_PACKAGE_URI=$GCS_BUCKET_URI/pgd-at-alexnet-trainer.tar.gz
export PYTHON_MODULE="pgd-at-alexnet-trainer.train_pgd_at_alexnet"
